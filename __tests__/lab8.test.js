describe('Basic user flow for SPA ', () => {
  ...
  it('Test5: On first Entry page - checking <entry-page> contents', async () => {
    /*
      ...
      */
     let firstEntry = await page.$eval("body > entry-page", entry1 => entry1.entry);
     let expectedContent = { 
      title: 'You like jazz?',
      date: '4/25/2021',
      content: "According to all known laws of aviation, there is no way a bee should be able to fly. Its wings are too small to get its fat little body off the ground. The bee, of course, flies anyway because bees don't care what humans think is impossible.",
    ...
    expect(firstEntry).toEqual(expectedContent);
  ...
  it('Test6: On first Entry page - checking <body> element classes', async () => {
    ...
    let attribute = await page.$eval("body", el => el.className);
  ...
  it('Test13: On the home page the <body> element should not have any class attribute', async() => {
    let body = await page.$eval("body", el => el.className);
    expect(body).toBe("");
  });
  ...
  it('Test16: Verify the entry page contents is correct when clicking on the second entry', async() => {
    let firstEntry = await page.$eval("body > entry-page", entry2 => entry2.entry);
    let expectedContent = { 
  ...
  it('Test17: Verify that pressing the back button from Entry 2 takes you to the home page', async() => {
    await page.goBack();
    let header = await page.$eval ("body > header > h1", el => el.textContent);
    expect(header).toBe("Journal Entries");
  });
  // create your own test 18
  it('Test18: Clicking the forward button should bring the user back to Entry 2', async() => {
    await page.goForward();
    let header = await page.$eval ("body > header > h1", el => el.textContent);
    expect(header).toBe("Entry 2");
  });
  // create your own test 19
  it('Test19: Navigate to Entry 3 from Entry 2', async() => {
  ...
  it('Test20: Verify the contents of Entry 3', async() => {
    let firstEntry = await page.$eval("body > entry-page", el => el.entry);
    let expectedContent = { 
